...
# ─────────────────────────
#   bash scripts/run_train_cv0_rerun.sh --config configs/efficientnetv2_s_cv0.yaml
#   bash scripts/run_train_cv0.sh --config configs_rerun/convnextv2_cv0.yaml --gpu 1
#   bash scripts/run_train_cv0.sh --config configs_rerun/eva02_base_cv0.yaml \
...
LOG_DIR="${LOG_DIR:-${PROJECT_ROOT}/rerun_results_3/${CONFIG_BASENAME}}"
