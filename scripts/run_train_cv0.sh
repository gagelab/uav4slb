...
# ─────────────────────────
#   bash scripts/run_train_cv0.sh --config configs/eva02_base_cv0.yaml
#   bash scripts/run_train_cv0.sh --config configs/convnextv2_cv0.yaml --gpu 1
#   bash scripts/run_train_cv0.sh --config configs/eva02_base_cv0.yaml \
...
LOG_DIR="${LOG_DIR:-${PROJECT_ROOT}/results/${CONFIG_BASENAME}}"
